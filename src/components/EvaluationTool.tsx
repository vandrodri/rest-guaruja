...
const [step, setStep] = useState<EvaluationStepType>(EvaluationStep.Input);
  ...
  const handleStart = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Extra safety to strip markdown symbols if the model ignores the prompt instruction
        ...
        <form onSubmit={handleStart} className="space-y-6 text-center max-w-2xl mx-auto py-8">
          ...
          <div className="space-y-6">
            <input 
              ...
              className="w-full bg-[#e0e0e0] shadow-[inset_4px_4px_8px_#b8b8b8,inset_-4px_-4px_8px_#ffffff] p-5 rounded-2xl focus:outline-none text-zinc-800 text-lg transition-all"
